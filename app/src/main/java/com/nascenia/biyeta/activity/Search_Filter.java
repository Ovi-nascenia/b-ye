...
public class Search_Filter extends CustomActionBarActivity implements OnClickListener {
    ...
    protected void onResume() {
        ...
        /*Google Analytics*/
        mTracker.setScreenName(getString(R.string.search));
...
//                    }
                ...
                e.printStackTrace();
//                application.trackEception(e, "GetResult/onPostExecute", "Search_Filter", e.getMessage().toString(), mTracker);
            }
...
//                    Log.i("post", res + "  data");
                    ...
                    e.printStackTrace();
                    Utils.ShowAlert(Search_Filter.this, getString(R.string.no_internet_connection));
//                    application.trackEception(e, "Get_Data/onPostExecute", "Search_Filter", e.getMessage().toString(), mTracker);
        ...
        protected String doInBackground(String... url) {
            ...
            try {
                ...
                e.printStackTrace();
//                application.trackEception(e, "Get_Data/doInBackground", "Search_Filter", e.getMessage().toString(), mTracker);
...
//            }
            ...
            e.printStackTrace();
//            application.trackEception(e, "parse_data", "Search_Filter", e.getMessage().toString(), mTracker);
        }
    }
}