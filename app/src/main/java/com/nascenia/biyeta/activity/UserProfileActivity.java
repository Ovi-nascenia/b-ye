    ...
    class GetData extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String responseJson) {
            ...
            try {
                ...
                e.printStackTrace();
//                application.trackEception(e, "GetData/onPostExecute", "UserProfileActivity", e.getMessage().toString(), mTracker);
            }
...
//                application.trackEception(e, "GetData/doInBackground", "UserProfileActivity", e.getMessage().toString(), mTracker);
            }
