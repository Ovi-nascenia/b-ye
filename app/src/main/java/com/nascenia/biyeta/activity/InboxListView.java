...
public class InboxListView extends CustomActionBarActivity {
    ...
    protected void onResume() {
        ...
        /*Google Analytics*/
        mTracker.setScreenName(getString(R.string.inbox));
        ...
        protected void onPostExecute(String s) {
            ...
            if (s == null) {
                ...
                try {
                    ...
                    emptyMessage.setVisibility(View.VISIBLE);
                    recyclerView.setVisibility(View.GONE);
//                    application.trackEception(e, "LoadMessageThread/onPostExecute", "InboxListView", e.getMessage().toString(), mTracker);
                }
        ...
        protected String doInBackground(String... strings) {
            ...
            try {
                ...
                e.printStackTrace();
//                application.trackEception(e, "LoadMessageThread/onPreExecute", "InboxListView", e.getMessage().toString(), mTracker);
            } catch (JSONException e) {
                e.printStackTrace();
//                application.trackEception(e, "LoadMessageThread/onPreExecute", "InboxListView", e.getMessage().toString(), mTracker);
            }
