...
public class Match extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mTracker.setScreenName("Match : বায়োডাটা");
    ...
    public void onClick(View view) {
        ...
        switch (id) {
            ...
            case R.id.connection:
                ...
                mTracker.setScreenName("Match : যোগাযোগ");
                mTracker.send(new HitBuilders.ScreenViewBuilder().build());
                break;
        }
                            ...
                            if(getActivity()!=null)
                                ...
                                public void LoadData() {
                                    ...
                                    if (connectionPageTrack > 1 && connectionPageTrack <= toalConnectionPage) {
                                        ...
                                        Log.e("communication url:",Utils.Base_URL+"/api/v1/communication_requests?page=" + connectionPageTrack);
                                        snackbar = Snackbar
...
/*
                    ...
                    emptyMessage.setVisibility(View.VISIBLE);
                    recyclerView.setVisibility(View.GONE);
//                    application.trackEception(e, "LoadConnection/onPostExecute", "Match", e.getMessage().toString(), mTracker);
                }
        ...
        protected String doInBackground(String... strings) {
            ...
            try {
                ...
                e.printStackTrace();
               // application.trackEception(e, "LoadConnection/doInBackground", "Match", e.getMessage().toString(), mTracker);
            }
        ...
        protected void onPostExecute(String s) {
            ...
            if (s == null) {
                ...
                try {
                    ...
                    e.printStackTrace();
//                    application.trackEception(e, "LoadBiodataConnection/onPostExecute", "Match", e.getMessage().toString(), mTracker);
                }
        ...
        protected String doInBackground(String... strings) {
            ...
            try {
                response = client.newCall(request).execute();
                String jsonData = response.body().string();
                Log.e("Profile Data", jsonData);
                return jsonData;

            } catch (Exception e) {
                e.printStackTrace();
                //application.trackEception(e, "LoadBiodataConnection/doInBackground", "Match", e.getMessage().toString(), mTracker);
            }
...
//                application.trackEception(e, "SendConnectionRequest/doInBackground", "Match", e.getMessage().toString(), mTracker);
                return null;
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == getActivity().RESULT_OK) {
            if(requestCode == Utils.UPGRADE_REQUEST_CODE){
                new NetWorkOperation.loadAccountBalance(getActivity(), application, mTracker).execute();
//                final AlertDialog.Builder alertBuilder = new AlertDialog.Builder(getActivity());
//                alertBuilder.setCancelable(true);
