...
public class Inbox extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v.findViewById(R.id.tv_favorites).setOnClickListener(this);
    ...
    class LoadReqeustSenderIdsTask extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                e.printStackTrace();
//                application.trackEception(e, "LoadReqeustSenderIdsTask/doInBackground", "Inbox", e.getMessage().toString(), mTracker);
            }
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                e.printStackTrace();
                //application.trackEception(e, "LoadReqeustSenderIdsTask/onPostExecute", "Inbox", e.getMessage().toString(), mTracker);
            }
