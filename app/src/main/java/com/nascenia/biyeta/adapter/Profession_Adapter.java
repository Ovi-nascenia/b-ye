...
public class Profession_Adapter extends BaseAdapter {
    ...
    private void addCheckBoxStatustoList(Boolean aBoolean, int position) {
        ...
        if (this.gridItemType.equals("LOCATION") && aBoolean) {
            ...
            removeItemfromGridViewList(Search_Filter.locationGridItemCheckedCheckBoxPositionList, Search_Filter.locationId.get(position));
            ...
            removeItemfromGridViewList(Search_Filter.professionGridItemCheckedCheckBoxPositionList, Search_Filter.professionId.get(position));
